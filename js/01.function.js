...
resultat4 = afficherOperation("Somme", somme, 20, 40);

resultat5 = afficherOperation("Multiplication", multiplication, 10, 20);

resultat6 = afficherOperation("Soustraction", function (nb1, nb2) {
    return nb1 - nb2;
}, 15, 5);